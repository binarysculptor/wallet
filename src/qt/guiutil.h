...
/** Utility functions used by the Liberty Qt UI.
 */
namespace GUIUtil
{
...
// Render Liberty addresses in monospace font
...
// Parse "liberty:" URI into recipient object, return true on successful parsing
