...
void OverviewPage::getPercentage(CAmount nUnlockedBalance, CAmount nZerocoinBalance, QString& sPIVPercentage, QString& szLBRTPercentage)
{
    int nPrecision = 2;
                              ...
                              const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    // PIV Available
    bool showPIVAvailable = settingShowAllBalances || lbrtAvailableBalance != nTotalBalance;
