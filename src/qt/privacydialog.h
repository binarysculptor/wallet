...
public:
    ...
    void setZLbrtControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzLBRT_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzLBRT_clicked();
    void on_pushButtonZLbrtControl_clicked();
