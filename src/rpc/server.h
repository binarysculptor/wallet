...
extern UniValue setzlbrtseed(const UniValue& params, bool fHelp);
extern UniValue getzlbrtseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzlbrt(const UniValue& params, bool fHelp);
extern UniValue dzlbrtstate(const UniValue& params, bool fHelp);
