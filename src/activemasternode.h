...
#define MASTERNODE_REQUIRED_AMOUNT                 50000
#define MASTERNODE_ACCEPTABLE_INPUTS_CHECK_AMOUNT  49999.99
...
private:
    ...
    /// Get 10000 Liberty input that can be used for the Masternode
