...
#define MASTERNODE_REQUIRED_AMOUNT                 5000
#define MASTERNODE_ACCEPTABLE_INPUTS_CHECK_AMOUNT  4999.99
...
private:
    ...
    /// Get 10000 LBRT input that can be used for the Masternode
