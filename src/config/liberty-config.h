/* src/config/liberty-config.h.  Generated from liberty-config.h.in by configure.  */
/* src/config/liberty-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef LIBERTY_CONFIG_H

#define LIBERTY_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.lbrt.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Liberty Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Liberty Core 5.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "liberty"
