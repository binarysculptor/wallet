...
UniValue setaccount(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("setaccount", "\"XRe9RPmHuBtiBA9iTUBWHRYtWPLR6zMxme\" \"tabby\"") + HelpExampleRpc("setaccount", "\"XRe9RPmHuBtiBA9iTUBWHRYtWPLR6zMxme\", \"tabby\""));
...
UniValue getaccount(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("getaccount", "\"XRe9RPmHuBtiBA9iTUBWHRYtWPLR6zMxme\"") + HelpExampleRpc("getaccount", "\"XRe9RPmHuBtiBA9iTUBWHRYtWPLR6zMxme\""));
...
UniValue signmessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            HelpExampleCli("verifymessage", "\"XRe9RPmHuBtiBA9iTUBWHRYtWPLR6zMxme\" \"signature\" \"my message\"") +
            "\nAs json rpc\n" +
            HelpExampleRpc("signmessage", "\"XRe9RPmHuBtiBA9iTUBWHRYtWPLR6zMxme\", \"my message\""));
...
UniValue getreceivedbyaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw std::runtime_error(
            ...
            HelpExampleCli("getreceivedbyaddress", "\"XRe9RPmHuBtiBA9iTUBWHRYtWPLR6zMxme\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n" +
            HelpExampleCli("getreceivedbyaddress", "\"XRe9RPmHuBtiBA9iTUBWHRYtWPLR6zMxme\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n" +
            HelpExampleCli("getreceivedbyaddress", "\"XRe9RPmHuBtiBA9iTUBWHRYtWPLR6zMxme\" 6") +
            "\nAs a json rpc call\n" +
            HelpExampleRpc("getreceivedbyaddress", "\"XRe9RPmHuBtiBA9iTUBWHRYtWPLR6zMxme\", 6"));
...
UniValue sendfrom(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 3 || params.size() > 6)
        throw runtime_error(
            ...
            "\nAs a json rpc call\n" +
            HelpExampleRpc("sendfrom", "\"tabby\", \"XRe9RPmHuBtiBA9iTUBWHRYtWPLR6zMxme\", 0.01, 6, \"donation\", \"seans outpost\""));
...
UniValue sendmany(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw runtime_error(
            ...
            "\nAs a json rpc call\n" +
            HelpExampleRpc("sendmany", "\"tabby\", \"{\\\"XRe9RPmHuBtiBA9iTUBWHRYtWPLR6zMxme\\\":0.01,\\\"DAD3Y6ivr8nPQLT1NEPX84DxGCw9jz9Jvg\\\":0.02}\", 6, \"testing\""));
...
UniValue addmultisigaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            HelpExampleCli("addmultisigaddress", "2 \"[\\\"XRe9RPmHuBtiBA9iTUBWHRYtWPLR6zMxme\\\",\\\"DAD3Y6ivr8nPQLT1NEPX84DxGCw9jz9Jvg\\\"]\"") +
            "\nAs json rpc call\n" +
            HelpExampleRpc("addmultisigaddress", "2, \"[\\\"XRe9RPmHuBtiBA9iTUBWHRYtWPLR6zMxme\\\",\\\"DAD3Y6ivr8nPQLT1NEPX84DxGCw9jz9Jvg\\\"]\""));
...
UniValue walletlock(const UniValue& params, bool fHelp)
{
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 0))
        throw runtime_error(
            ...
            HelpExampleCli("sendtoaddress", "\"XRe9RPmHuBtiBA9iTUBWHRYtWPLR6zMxme\" 1.0") +
...
UniValue spendzerocoin(const UniValue& params, bool fHelp)
{
    ...
    return DoXlibzSpend(nAmount, fMintChange, fMinimizeChange, vMintsSelected, address_str);
}
...
UniValue spendzerocoinmints(const UniValue& params, bool fHelp)
{
    ...
    return DoXlibzSpend(nAmount, false, true, vMintsSelected, address_str);
}


extern UniValue DoXlibzSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str)
{
    ...
    if (fHelp || params.empty() || params.size() > 2)
        throw runtime_error(
            ...
            HelpRequiringPassphrase() + "\n"
                                        ...
                                        "  {\n"
                                        "    \"id\": \"serial hash\",  (string) the mint's XLIBz serial hash \n"
...
UniValue spendrawzerocoin(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 4 || params.size() > 5)
        throw runtime_error(
            ...
            "5. \"address\"          (string, optional) XLIB address to spend to. If not specified, spend to change add.\n"
...
UniValue clearspendcache(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            "clearspendcache\n"
            "\nClear the pre-computed XLIBz spend cache, and database.\n" +
            HelpRequiringPassphrase() + "\n"
...

    {
        ...
        while (nTries < 100) {
            ...
            if (fLocked) {
                if (xlibzTracker->ClearSpendCache()) {
