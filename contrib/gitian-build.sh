...
VERSION=
commit=false
url=https://github.com/project-liberty/liberty
proc=2
mem=2000
lxc=true
...
-u|--url    Specify the URL of the repository. Default is https://github.com/project-liberty/liberty
...
then
    # Make output folder
    mkdir -p ./liberty-binaries/${VERSION}
