...
def setup():
    ...
    if not os.path.isdir('gitian.sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/liberty-Project/gitian.sigs.git'])
    if not os.path.isdir('liberty-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/liberty-Project/liberty-detached-sigs.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('PIVX'):
        subprocess.check_call(['git', 'clone', 'https://github.com/liberty-Project/PIVX.git'])
...
def build():
    ...
    os.makedirs('liberty-binaries/' + args.version, exist_ok=True)
    ...
    if args.linux:
        ...
        subprocess.check_call('mv build/out/liberty-*.tar.gz build/out/src/liberty-*.tar.gz ../liberty-binaries/'+args.version, shell=True)
    ...
    if args.windows:
        ...
        subprocess.check_call('mv build/out/liberty-*-win-unsigned.tar.gz inputs/', shell=True)
        subprocess.check_call('mv build/out/liberty-*.zip build/out/liberty-*.exe ../liberty-binaries/'+args.version, shell=True)
    ...
    if args.macos:
        ...
        subprocess.check_call('mv build/out/liberty-*-osx-unsigned.tar.gz inputs/', shell=True)
        subprocess.check_call('mv build/out/liberty-*.tar.gz build/out/liberty-*.dmg ../liberty-binaries/'+args.version, shell=True)
...
def sign():
    ...
    if args.windows:
        ...
        subprocess.check_call('cp inputs/liberty-' + args.version + '-win-unsigned.tar.gz inputs/liberty-win-unsigned.tar.gz', shell=True)
        ...
        subprocess.check_call('mv build/out/liberty-*win64-setup.exe ../liberty-binaries/'+args.version, shell=True)
        subprocess.check_call('mv build/out/liberty-*win32-setup.exe ../liberty-binaries/'+args.version, shell=True)

    if args.macos:
        print('\nSigning ' + args.version + ' MacOS')
        subprocess.check_call('cp inputs/liberty-' + args.version + '-osx-unsigned.tar.gz inputs/liberty-osx-unsigned.tar.gz', shell=True)
        ...
        subprocess.check_call('mv build/out/liberty-osx-signed.dmg ../liberty-binaries/'+args.version+'/liberty-'+args.version+'-osx.dmg', shell=True)
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/liberty-Project/PIVX', help='Specify the URL of the repository. Default is %(default)s')
