...
#   c) node1 mines 32 blocks, so now node 0 has 60001XLIB, node 1 has 4250XLIB, node2 has none.
#   d) node0 sends 601 XLIB to node2, in two transactions (301 XLIB, then 300 XLIB).
