...
#   c) node1 mines 32 blocks, so now node 0 has 60001lbrt, node 1 has 4250lbrt, node2 has none.
#   d) node0 sends 601 lbrt to node2, in two transactions (301 lbrt, then 300 lbrt).
