...
#   c) node1 mines 32 blocks, so now node 0 has 60001XLB, node 1 has 4250XLB, node2 has none.
#   d) node0 sends 601 XLB to node2, in two transactions (301 XLB, then 300 XLB).
