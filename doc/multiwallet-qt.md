...
In order to support loading of multiple wallets in liberty-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is liberty.cpp.
...
Changes to liberty.cpp
----------------------
liberty.cpp is the entry point into liberty-qt, and as such, will require some minor modifications to provide hooks for
