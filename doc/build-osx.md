...
commands:
    ...
    echo -e "rpcuser=libertyrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Supportlibertycoreliberty.conf"
    chmod 600 "/Users/${USER}/Library/Application Supportlibertycoreliberty.conf"

The next time you run it, it will start downloading the blockchain, but it won't
output anything while it's doing this. This process may take several hours;
you can monitor its process by looking at the debug.log file, like this:

    tail -f $HOME/Library/Application\ Supportlibertycoredebug.log
