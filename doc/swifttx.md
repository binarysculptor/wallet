...
This mechanism has been integrated into Bitcore-Node-Liberty which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/project-liberty/insight-api-liberty#web-socket-api](https://github.com/project-liberty/insight-api-liberty#web-socket-api)
* API: [https://github.com/project-liberty/insight-api-liberty#swifttx-transactions](https://github.com/project-liberty/insight-api-liberty#swifttx-transactions)
...
By default, the Liberty Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Liberty Core daemon:
