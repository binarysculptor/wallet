...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/project-libertylibertycoreblob/master/doc/translation_process.md#synchronising-translations).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/liberty-project/liberty.git
...
- Detached signatures will then be committed to the [liberty-detached-sigs](https://github.com/project-liberty/liberty-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the lbrt.io server*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/project-libertylibertycorereleases/new) with a link to the archived release notes.
