...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/Liberty-Project/Liberty/blob/master/doc/translation_process.md#synchronising-translations).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/project-liberty/liberty.git
...
### Build and sign Liberty Coin for Linux, Windows, and OS X:
...
- Detached signatures will then be committed to the [liberty-detached-sigs](https://github.com/Liberty-Project/liberty-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/Liberty-Project/Liberty/releases/new) with a link to the archived release notes.
