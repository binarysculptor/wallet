UNIX BUILD NOTES
====================
Some notes on how to build Liberty in Unix.
...
This will build Liberty-Qt as well if the dependencies are met.
...
memory available when compiling Liberty Coin. With 512MB of memory or less
...
Once these are installed, they will be found by configure and a Liberty-Qt executable will be
built by default.
...
# Configure Liberty Coin to use our own-built instance of BDB
cd $LIBERTY_ROOT
...
Security
--------
To help make your LIBERTY installation more secure by making certain attacks impossible to
